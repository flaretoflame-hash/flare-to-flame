...
\- Both loaded via Google Fonts in app CSS
...
\- Background: #F3ECED off-white always

\- Text: #2C2C2C dark charcoal

\- Accent: #C9A84C gold — accent only, never fill
...
\- Category label: Outfit 12px uppercase letter-spaced

\- Service name: Playfair Display bold 22px

\- Story/description: Playfair Display italic 14px

\- CTA button: Outfit 14px medium



\## What Claude NEVER Does to Service Cards

\- Never changes the cinematic PNG background
